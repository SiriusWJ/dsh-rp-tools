...
function defaultStyles() {
  ...
  return {
    ...
    // `userLabel` 是 1.8.7 之前的老字段，保留一格并由迁移保持同步（外部/老代码还在读它）。
    cards: { root: '', userLabel: '', macros: {} },
    styles: {
...
function loadStyles() {
  ...
  if (!cfg.cards || typeof cfg.cards !== 'object') {
    cfg.cards = { root: '', userLabel: '', macros: {} };
  } else {
    ...
    if (!cfg.cards.macros || typeof cfg.cards.macros !== 'object') {
