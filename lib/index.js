...
import { buildImport, cardToMarkdown, cardToOpeningFile, buildOpeningPrompt, DEFAULT_USER_LABEL, localizeAttributes, listGreetings, discoverMacros, collectCardText, MACRO_NAME_RE } from './card-import.js';
...
function neutralizeMustache(text, known) {
  ...
  const keepSet = known instanceof Set ? known : new Set(known ?? ['user']);
  const keep = [];
