  ...
  return {
    ...
    styles: {
      ...
      uncensored_anime: mk('二次元', 'tone001_manga.safetensors',
        ...
        { workflow: 'uncensored_anime', cfg: 5.5, steps: 20, sizes: { scene: [1024, 1024], portrait: [768, 1024], item: [1024, 1024] } }),
      uncensored_real: mk('写实', null,
        ...
        { workflow: 'uncensored_real', cfg: 1, steps: 20, sizes: { scene: [1024, 1024], portrait: [768, 1024], item: [1024, 1024] } }),
      manga: mk('黑白漫画', null,
